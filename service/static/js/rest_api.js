$(function () {
    ...
    $("#update_wishlist_btn").click(function () {
        ...
        let ajax = $.ajax({
            type: "PUT",
            url: `/api/wishlists/${wishlist_id}`,  // Using template literals to insert the wishlist_id into the URL
            contentType: "application/json",
            data: JSON.stringify(data),
        });
    ...
    $("#archive_wishlist_btn").click(function () {
        ...
        let ajax = $.ajax({
            type: "PUT",
            url: `/api/wishlists/${wishlist_id}/archive`
        })
    ...
    $("#unarchive_wishlist_btn").click(function () {
        ...
        let ajax = $.ajax({
            type: "PUT",
            url: `/api/wishlists/${wishlist_id}/unarchive`
        })
    ...
    $("#update_product_btn").click(function () {
        ...
        let ajax = $.ajax({
                type: "PUT",
                url: `/api/wishlists/${wishlist_id}/products/${product_model_id}`,
                contentType: "application/json",
                data: JSON.stringify(data)
            })
    ...
    $("#search_product_btn").click(function () {
        ...
        let ajax = $.ajax({
            type: "GET",
            url: `/api/wishlists/${wishlist_id}/products?${queryString}`,
            contentType: "application/json",
            data: ''
        })
